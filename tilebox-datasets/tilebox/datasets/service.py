...
_time_field = Field(
    ...
    annotation=FieldAnnotation(
        ...
        source_json_pointer="/properties/datetime",
        json_schema_ref=(
            "https://schemas.stacspec.org/v1.1.0/item-spec/json-schema/datetime.json#/properties/datetime"
        ),
    ),
)
...
_id_field = Field(
    ...
    annotation=FieldAnnotation(
        ...
        source_json_pointer="/properties/tilebox_id",
    ),
)
...
_ingestion_time_field = Field(
    ...
    annotation=FieldAnnotation(
        ...
        example_value="2022-10-17T14:35:28Z",
        source_json_pointer="/properties/created",
        json_schema_ref=("https://schemas.stacspec.org/v1.1.0/item-spec/json-schema/datetime.json#/properties/created"),
    ),
)
...
_geometry_field = Field(
    ...
    annotation=FieldAnnotation(
        ...
        source_json_pointer="/geometry",
        json_schema_ref="https://geojson.org/schema/Geometry.json",
    ),
)
