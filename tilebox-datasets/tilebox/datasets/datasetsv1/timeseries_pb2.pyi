...
class TimeseriesDatasetChunk(_message.Message):
    ...
    def __init__(self, dataset_id: _Optional[_Union[_core_pb2.ID, _Mapping]] = ..., collection_id: _Optional[_Union[_core_pb2.ID, _Mapping]] = ..., time_interval: _Optional[_Union[_core_pb2.TimeInterval, _Mapping]] = ..., datapoint_interval: _Optional[_Union[_core_pb2.DatapointInterval, _Mapping]] = ..., branch_factor: _Optional[int] = ..., chunk_size: _Optional[int] = ..., datapoints_per_365_days: _Optional[int] = ...) -> None: ...
...
class TimeChunk(_message.Message):
    ...
    def __init__(self, time_interval: _Optional[_Union[_core_pb2.TimeInterval, _Mapping]] = ..., chunk_size: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
